...
public class DeviceDao {
	...
	public boolean update(Device device){
		...
		try {
			...
			pstmt.setInt(6, device.getTemp());
			pstmt.setInt(7, device.getTempUpLimit());
			pstmt.setInt(8, device.getTempDownLimit());
			pstmt.setInt(9, device.getTempOff());
			pstmt.setInt(10, device.getTempReally());
			...
			pstmt.setInt(15, device.getHr());
			pstmt.setInt(16, device.getHrUpLimit());
			pstmt.setInt(17, device.getHrDownLimit());
			pstmt.setInt(18, device.getHrOff());
			pstmt.setInt(19, device.getHrReally());
			...
			pstmt.setInt(24, device.getDp());
			pstmt.setInt(25, device.getDpUpLimit());
			pstmt.setInt(26, device.getDpDownLimit());
			pstmt.setInt(27, device.getDpOff());
			pstmt.setInt(28, device.getDpReally());
